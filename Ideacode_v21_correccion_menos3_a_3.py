...
def programa_usuario():
    ...
    Funciones disponibles:
        avance(segundos, velocidad)                # Solo giroscopio
        reversa(segundos, velocidad)               # Solo giroscopio
        detenerse(segundos)
        girar(direccion, angulo, velocidad_base)   # Solo giroscopio

        avance_hasta(numero_interseccion, velocidad_base)
        reversa_hasta(numero_interseccion, velocidad_base)
        # Las dos funciones anteriores usan giroscopio + infrarrojos.
    ...
    #avance_hasta(numero_interseccion=2, velocidad_base=0)
    ...
    # reversa_hasta(1, 20)
    # reversa(1, 20)
    # mover_garra(1.0, 30, "abrir")
    # mover_pala(1.0, 40, "subir")
...
print("Iniciando LPF2 de 8 bits: ruedas, garra, pala y 5 sensores...")
...
while True:
    ...
    while connected:
        try:
            ...
            # La calibracion solo ocurre despues de presionar el boton.
            calibrar_giroscopio()
            programa_usuario()
            confirmar_parada(cambiar_color=True)
